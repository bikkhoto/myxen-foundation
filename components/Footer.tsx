...
export function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 bg-white py-12 dark:border-gray-800 dark:bg-black" role="contentinfo">
      <div className="container mx-auto px-4">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4" role="list" aria-label="Social media links">
              ...
              <a
                href="https://github.com/bikkhoto/myxen-foundation"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 transition-colors hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <li>
                <a href="#wallets" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Transparency
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center text-sm text-gray-600 dark:border-gray-800 dark:text-gray-400">
          <p>© {currentYear} MyXen Foundation. Open source under MIT License.</p>
          <p className="mt-2">
            Built with ❤️ on{' '}
            <a 
